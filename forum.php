...
if(!$_SESSION['id_user']){
  header('location:index.php?c=forum');
}
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="index.php?c">Accueil <i class="ion-ios-arrow-forward"></i></a></span> <span>Commentaires <i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="ftco-section contact-section" style="margin-top: -80px;">
    <div class="container">
      ...
      ?>
          ...
          <div class="media">
            ...
            <div class="media-body">
              <h4 class="media-heading"> 
                <i>
                  <span><?php echo $results->data[$i]['prenom_user'].' '.$results->data[$i]['nom_user'].' ('.$results->data[$i]['pseudo'].') '; ?></span>
                  <span style="float: right; font-size: 14px"><?php echo $results->data[$i]['date_commentaire'].' à '.$results->data[$i]['heure_commentaire'].'H '.$results->data[$i]['minute_commentaire'].'min '; ?></span>
                </i> 
              </h4>
              <p><?php $data = nl2br($results->data[$i]['commentaire']); echo $data; ?></p>
            </div>
          </div>
          <br>
        <?php } ?>
        <div class="row">
          <?php
          if($paginator->createLinks($links)){
        ...
        <form action="ajout_commentaire.php" method="post">
          <textarea id="message" name="commentaire" cols="40" rows="4" placeholder="Commenter..." required></textarea>
          <input type="number" name="id_user" placeholder="id_user" value="<?php echo $_SESSION['id_user'] ?>" hidden />
          <input type="number" name="annee_commentaire" placeholder="annee_commentaire" value="<?php echo $annee ?>" hidden />
          <input type="text" name="heure_commentaire" placeholder="heure_commentaire" value="<?php echo $heure ?>" hidden />
          <input type="text" name="minute_commentaire" placeholder="minute_commentaire" value="<?php echo $minute ?>" hidden />
          <input type="text" name="date_commentaire" placeholder="minute_commentaire" value="<?php echo $date_jour ?>" hidden />

          <input type="submit" name="publier" value="Commentez" style="margin-top: -28px; margin-left: 0px;" class="btn btn-primary py-2 px-3" />
        </form>
        </p>
