                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_contact" id="id_contact" class="form-control "
                                            readonly />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="identite" id="identite" class="form-control "
                                            readonly />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="msg" id="msg" class="form-control " readonly></textarea>
                                        <!-- <input type="number" name="message" id="message" class="form-control "
                                            readonly /> -->
                                        <span id="erreur_message" class="text-danger"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="mois_message">Mois du message</label>
                                        <input type="text" name="mois_message" id="mois_message" class="form-control "
                                            readonly />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="annee_message">Année du message</label>
                                        <input type="text" name="annee_message" id="annee_message" class="form-control "
                                            readonly />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="heure_message">Heure du message</label>
                                        <input type="text" name="heure_message" id="heure_message" class="form-control "
                                            readonly />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="statut">Marquez comme lu</label>
                                        <!-- <input type="text" name="statut" id="statut" class="form-control " /> -->
                                        <select id="statut" class="form-control" name="statut" id="statut">
                                            <option></option>
                                            <option>Lu</option>
                                        </select>
        ...
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-subhead-line">Voici la liste de vos messages.
                    </h1>
