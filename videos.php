    ...
    <div class="container-fluid bg-dark d-flex align-items-center px-4">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active"><a href="videos.php" class="nav-link">Vidéos</a></li>
    ...
    <div class="container" style="margin-top: -100px;">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 ftco-animate">
          ...
          <video controls preload="metadata" style="width:350px;height:350px; border: none">
								<source src="videos/<?php echo $results->data[$i]['video'] ?>">
							
					</video>
            <p class="text-justify"><?php echo $results->data[$i]['libelle'] ?></p>
          </div>
        </div>
        <?php
              }
