...
<body>
				...
				<div class="col-md-4 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
					<div class="media block-6 d-block text-center">
						...
						<div class="media-body p-2 mt-3">
							...
							<h3 class="heading" style="margin-top: 150px;">Nombre de visites : <?php echo $users; ?></h3>
							<a href="http://www.facebook.com/PatrickEric" target="_blank" style="text-decoration: none;"> 
								<i class="fa fa-facebook-square fa-3x" style="margin-top: 100px; color: white; /*#3b5998;*/"></i>
							</a>
							<a href="http://www.twitter.com/home" target="_blank" style="text-decoration: none;">
				...
				<div class="col-md-4 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
					<div class="media block-6 d-block text-center">
						...
						<div class="media-body p-2 mt-3">
							...
							<?php $i=0; while($ett=$aff2->fetch()){ $i++; ?>
							<img src="images/WhatsApp Image 2021-03-20 at 09.27.50.jpeg" alt="" style="width: 100%;">
							<?php }?>
						</div>
					</div>
				</div>
				<div class="col-md-4 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
					<div class="media block-6 d-block text-center">
						...
						<div class="media-body p-2 mt-3">
							...
							<?php $i=0; while($et=$aff->fetch()){ $i++; ?>
							<img src="images/WhatsApp Image 2021-04-14 at 18.20.50.jpeg" alt="" style="width: 100%;">
							<?php }?>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-6">
							<div class="services-2 d-flex">
								<div class="icon mt-2 d-flex justify-content-center align-items-center"><span
										class="ion-ios-settings"></span></div>
								<div class="text pl-3">
	...
	<section class="ftco-section ftco-counter img" id="section-counter"
		style="background-image: url(images/DSC_0070.jpg);" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row justify-content-center mb-5 pb-2 d-flex">
				<div class="col-md-6 align-items-stretch d-flex">
					<div class="img img-video d-flex align-items-center"
						style="background-image: url(images/about-2s.jpg);">
