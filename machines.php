    ...
    <div class="container-fluid bg-dark d-flex align-items-center px-4">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active"><a href="machines.php" class="nav-link">Boutique</a></li>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          <h1 class="mb-2 bread">Machines à vendre</h1>
          ...
          <div class="blog-entry img1">
            <a class="block-20 d-flex align-items-end"
              ...
              <div class="meta-date text-center p-2 middle">
                  <span class="day text"><?php echo $results->data[$i]['libelle'] ?></span>
